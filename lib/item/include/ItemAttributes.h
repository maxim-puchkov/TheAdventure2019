...
private:
    ...
    ItemAttributes default_data_instance() const noexcept override;
...
void ItemAttributes::clear() noexcept {
    this->health = NO_VALUE;
    this->damage = NO_VALUE;
}

ItemAttributes ItemAttributes::default_data_instance() const noexcept {
    return ItemAttributes::DEFAULT_INSTANCE;
}
